...
<!--					<div class='wst-user-top-search'>
    ...
    <div class="wst-body">
        <table class="table table-hover table-striped table-bordered wst-list">
            ...
            <tr>
                <th width='30'>&nbsp;</th>
                <th width='120'>被推荐人</th>
                <th width='120'>被推荐人微信</th>
                <th width='120'>推荐人</th>
                <th width='120'>推荐人微信</th>
            ...
            <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                    <td><?php echo ($i); ?></td>
                    <td><?php echo ($vo['cuser']['loginName']); ?></td>
                    <td><?php echo ($vo['cuser']['userWebchat']); ?>&nbsp;</td>
                    <td><?php echo ($vo['ruser']['loginName']); ?></td>
                    <td><?php echo ($vo['ruser']['userWebchat']); ?>&nbsp;</td>
                    ...
                    <td>
                        <?php if($vo['status']==0): ?><a class="btn btn-default glyphicon glyphicon-pencil" href="<?php echo U('Home/Members/applySolve',array('id'=>$vo['id']));?>">确认审核</a>&nbsp;
