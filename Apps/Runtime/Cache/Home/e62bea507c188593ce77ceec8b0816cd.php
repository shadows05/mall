...
<link rel="stylesheet" href="/wstmall/Apps/Home/View/default/css/index.css" />
<link rel="stylesheet" href="/wstmall/Apps/Home/View/default/css/base.css" />
<link rel="stylesheet" href="/wstmall/Apps/Home/View/default/css/head.css" />
</head>
<body>
...
<div id="mainsearchbox" style="text-align:center;">
	<div id="wst-search-pbox">
		<div style="float:left;width:1240px;" class="wst-header-car">
		  <a href='<?php echo WSTDomain();?>'>
			<img id="wst-logo" width='1240' height='132' src="<?php echo WSTDomain();?>/<?php echo ($CONF['mallLogo']); ?>"/>
		  </a>
		</div>
		<!--<div id="wst-search-container">-->
			...
			<!--<div id="wst-hotsearch-keys">-->
				<!--<?php if(is_array($CONF['hotSearchs'])): $k = 0; $__LIST__ = $CONF['hotSearchs'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($k % 2 );++$k;?>-->
				<!--<a href="<?php echo U('Home/goods/getGoodsList',array('keyWords'=>$vo));?>"><?php echo ($vo); ?></a><?php if($k < count($CONF['hotSearchs'])): ?>&nbsp;&nbsp;|&nbsp;&nbsp;<?php endif; ?>-->
		...
		<!--<div id="wst-search-des-container">-->
			<!--<div class="des-box">-->
				<!--<div class='wst-reach'>-->
					<!--<img src="/wstmall/Apps/Home/View/default/images/sadn.jpg"  height="38" width="40"/>-->
				...
				<!--</div>-->
				<!--<div class='wst-since'>-->
					<!--<img src="/wstmall/Apps/Home/View/default/images/sqzt.jpg"  height="38" width="40"/>-->
		...
		<div class="wst-slide" id="wst-slide">
			<ul class="wst-slide-items">
				<?php if(is_array($indexAds)): $k = 0; $__LIST__ = $indexAds;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($k % 2 );++$k;?><li style="z-index: 1;"><a target="_blank" onclick="addAccess(<?php echo ($vo['adId']); ?>)" href="<?php echo ($vo['adURL']); ?>">
						<img src="/wstmall/<?php echo ($vo['adFile']); ?>" height="360" width="100%" title="<?php echo ($vo['adName']); ?>" />
				</a></li><?php endforeach; endif; else: echo "" ;endif; ?>
			</ul>
		</div>
	</div>
			...
			<div class="wst-fl-left wst-fl<?php echo ($k1); ?>" style="position: relative;">
				<div
					...
					<?php if(is_array($catAds[$vo1['catId']])): $kv = 0; $__LIST__ = $catAds[$vo1['catId']];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($kv % 2 );++$kv;?><a onclick="addAccess(<?php echo ($vo['adId']); ?>)" href="<?php echo ($vo['adURL']); ?>" target="_blank"> 
						<img class='lazyImg' data-original="/wstmall/<?php echo ($vo['adFile']); ?>" height="275" width="210" title="<?php echo ($vo['adName']); ?>" />
					</a><?php endforeach; endif; else: echo "" ;endif; ?>
				</div>
				<div
					style="position: absolute; top: 0px; left: 0px; width: 99%; height: 40px; padding-left: 10px; color: #ffffff; line-height: 38px; font-weight: bolder; background: url(/wstmall/Apps/Home/View/default/images/<?php echo ($k1); ?>fhd.png) no-repeat 100% 100%;">
					<a
						...
						<?php if(is_array($vo1['jpgoods'])): $k2 = 0; $__LIST__ = $vo1['jpgoods'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo2): $mod = ($k2 % 2 );++$k2;?><li class="wst-goodsbox">
							...
							<div class="wst-goods-thumb-des">
								...
								<div>
									...
									<img src="/wstmall/Apps/Home/View/default/images/btn_addcart.png" width="85" />
									</a>
									<div class='wst-clear'></div>
								</div>
							</div>
							...
							<div class="wst-goods-thumb-des">
								...
								<div>
									...
									<a href="javascript:addCart(<?php echo ($vo3['goodsId']); ?>,0,'<?php echo ($vo3['goodsThums']); ?>')" class="wst-right btnCart" > <img
										src="/wstmall/Apps/Home/View/default/images/btn_addcart.png"
										width="85" />
									</a>
									<div class='wst-clear'></div>
								</div>
						...
						<?php if(is_array($vo1['recommendShops'])): $k2 = 0; $__LIST__ = $vo1['recommendShops'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo2): $mod = ($k2 % 2 );++$k2;?><div style="width: 180px; margin-top: 10px;">
							<div style="width: 180px;">
								<a
									...
									<img class='lazyImg' data-original="/wstmall/<?php echo ($vo2['shopImg']); ?>" height="120" width="180" />
								</a>
							</div>
						</div><?php endforeach; endif; else: echo "" ;endif; ?>
					</div>
...
<div class="wst-footer-hp-box">
	...
	<link rel="stylesheet" type="text/css" href="/wstmall/Apps/Home/View/default/css/cart.css" />
<script src="/wstmall/Apps/Home/View/default/js/userlogin.js"></script>
<script type="text/javascript" src="/wstmall/Apps/Home/View/default/js/cart/common.js?v=725"></script>
<script type="text/javascript" src="/wstmall/Apps/Home/View/default/js/cart/quick_links.js"></script>
<!--[if lte IE 8]>
<script src="/wstmall/Apps/Home/View/default/js/cart/ieBetter.js"></script>
<![endif]-->
<script src="/wstmall/Apps/Home/View/default/js/cart/parabola.js"></script>
<!--右侧贴边导航quick_links.js控制-->
	<div id="flyItem" class="fly_item" style="display:none;">
		<p class="fly_imgbox">
		<img src="/wstmall/Apps/Home/View/default/images/item-pic.jpg"
			width="30" height="30">
		</p>
	</div>
			...
			<div class="quick_links_panel">
				<div id="quick_links" class="quick_links">
						...
						<div class="ibar_login_box status_login">
							<?php if($WST_USER['userId'] > 0): ?><div class="avatar_box">
								<p class="avatar_imgbox">
									<img
										src="/wstmall/Apps/Home/View/default/images/no-img_mid_.jpg" />
								</p>
							...
							<div class="ibar_recharge-field">
								...
								<label class="img" onclick="javascript:getVerify()">
				                	<img style='vertical-align:middle;cursor:pointer;height:30px;width:93px;' class='verifyImg' src='/wstmall/Apps/Home/View/default/images/clickForVerify.png' title='刷新验证码' onclick='javascript:getVerify()'/> 
								</label>
							</div>
							<div class="ibar_recharge-btn">
					...
					<!--<li>-->
						...
						<!--<img src="/wstmall/Apps/Home/View/default/images/qq.jpg"  height="38" width="40" />-->
						<!--</a>-->
					<!--</li>-->
					<!--<?php endif; ?>-->
				...
				<!--<div class="quick_toggle">-->
					<!--<li><a href="#none"><i class="mpbtn_qrcode"></i></a>-->
						<!--<div class="mp_qrcode" style="display: none;">-->
							<!--<img-->
								<!--src="/wstmall/Apps/Home/View/default/images/wstmall_weixin.png"-->
    ...
    <script src="/wstmall/Apps/Home/View/default/js/index.js"></script>
    <script src="/wstmall/Apps/Home/View/default/js/common.js"></script>
    <script src="/wstmall/Apps/Home/View/default/js/global.js" type="text/javascript"></script>
    <script src="/wstmall/Apps/Home/View/default/js/head.js" type="text/javascript"></script>
    <script src="/wstmall/Apps/Home/View/default/js/goods.js" type="text/javascript"></script>
</body>
