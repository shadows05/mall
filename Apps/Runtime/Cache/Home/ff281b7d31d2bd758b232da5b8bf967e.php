    ...
    <div class="wst-body">
        <table class="table table-hover table-striped table-bordered wst-list">
            ...
            <tr>
                <th width='30'>&nbsp;</th>
                <th width='120'>会员</th>
                <th width='120'>会员微信</th>
                <th width='120'>会员电话</th>
                <th width='120'>会员等级</th>
                <th width='160'>会员代金券</th>
            </tr>
            </thead>
            <tbody>
            <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                    <td><?php echo ($i); ?></td>
                    <td><?php echo ($vo['base']['loginName']); ?></td>
                    <td><?php echo ($vo['base']['userWebchat']); ?>&nbsp;</td>
                    <td><?php echo ($vo['base']['userPhone']); ?></td>
                    <td><?php echo ($vo['level']); ?>&nbsp;</td>
                    <td><?php echo ($vo['voucher']); ?>&nbsp;</td>
