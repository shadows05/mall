    ...
    <div class="wst-body">
        <table class="table table-hover table-striped table-bordered wst-list">
            ...
            <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                    <td><?php echo ($i); ?></td>
                    <td><?php echo ($vo['apply_user']['loginName']); ?></td>
                    <td><?php echo ($vo['apply_user']['userWebchat']); ?>&nbsp;</td>
                    <td><?php echo ($vo['apply_conten']); ?></td>
                    ...
                    <td>
                        <?php if($vo['status']==0): ?><a class="btn btn-default glyphicon glyphicon-pencil" href="<?php echo U('Home/Members/applyPromote',array('id'=>$vo['id']));?>">确认审核</a>&nbsp;
