...
<html lang="zh-cn">
   <head>
      ...
      <link href="/wstmall/Apps/Admin/View/css/upload.css" rel="stylesheet" type="text/css" />
      <!--[if lt IE 9]>
      ...
      <script type="text/javascript" src="/wstmall/Apps/Admin/View/js/upload.js"></script>
...
//	   params.userTotalScore = $.trim($('#userTotalScore').val());
   ...
   <body class="wst-page">
			...
			<form id="uploadform_Filedata" autocomplete="off" style="position:absolute;top:275px;left:120px;z-index:10;" enctype="multipart/form-data" method="POST" target="upload" action="<?php echo U('Home/Shops/uploadPic');?>" >
       ...
       <form name="myform" method="post" id="myform" autocomplete="off">
        <input type='hidden' id='id' name="id" value='<?php echo ($object["userId"]); ?>'/>
        ...
        <table class="table table-hover table-striped table-bordered wst-form">
           <tr>
             ...
             <td rowspan='6'>
                 ...
                 <img id='userPhotoPreview' src='<?php if($object['userPhoto'] =='' ): ?>/wstmall/Apps/Admin/View/img/staff.png<?php else: ?>/wstmall/<?php echo ($object['userPhoto']); endif; ?>' height='160'/><br/>
	            </div>
             </td>
           </tr>
           <tr>
