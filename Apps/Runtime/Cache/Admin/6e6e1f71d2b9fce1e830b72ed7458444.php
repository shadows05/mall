        ...
        <table class="table table-hover table-striped table-bordered wst-form">
           <tr>
             ...
             <td rowspan='6'>
                 ...
                 <img id='userPhotoPreview' src='<?php if($object['userPhoto'] =='' ): ?>/wstmall/Apps/Admin/View/img/staff.png<?php else: ?>/wstmall/<?php echo ($object['userPhoto']); endif; ?>' height='152'/><br/>
	             </div>
             </td>
           </tr>
           <tr>
