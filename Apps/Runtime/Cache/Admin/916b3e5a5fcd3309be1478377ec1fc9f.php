...
<html>
    <head>
        ...
        <meta content='width=device-width, initial-scale=1, maximum-scale=1, user-scalable=no' name='viewport'>
        <link href="/wstmall/Public/plugins/bootstrap/css/bootstrap.min.css" rel="stylesheet">
        <link href="/wstmall/Apps/Admin/View/css/font-awesome.min.css" rel="stylesheet" type="text/css" />
        <!-- Ionicons -->
        <link href="/wstmall/Apps/Admin/View/css/ionicons.min.css" rel="stylesheet" type="text/css" />
        <!-- Theme style -->
        <link href="/wstmall/Apps/Admin/View/css/AdminLTE.css" rel="stylesheet" type="text/css" />
        <script src="/wstmall/Public/js/jquery.min.js"></script>
        <!-- HTML5 Shim and Respond.js IE8 support of HTML5 elements and media queries -->
        <!-- WARNING: Respond.js doesn't work if you view the page via file:// -->
        <!--[if lt IE 9]>
          <script src="/wstmall/Public/js/html5shiv.min.js"></script>
          <script src="/wstmall/Public/js/respond.min.js"></script>
        <![endif]-->
        
        <script src="/wstmall/Public/plugins/bootstrap/js/bootstrap.min.js"></script>
        <script src="/wstmall/Apps/Admin/View/js/jquery-ui.min.js" type="text/javascript"></script>
        <!-- AdminLTE App -->
        <script src="/wstmall/Apps/Admin/View/js/AdminLTE/app.js" type="text/javascript"></script>
                        ...
                        <li class="dropdown user user-menu">
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li class="user-header bg-light-blue">
                                    <img src="/wstmall/<?php echo session('WST_STAFF.staffPhoto');?>" class="img-circle" alt="<?php echo session('WST_STAFF.roleName');?>" />
                                    <p>
                ...
                <section class="sidebar">
                    ...
                    <div class="user-panel">
                        <div class="pull-left image">
                            <img src="/wstmall/<?php echo session('WST_STAFF.staffPhoto');?>" class="img-circle" alt="<?php echo session('WST_STAFF.staffName');?>" />
                        </div>
                    ...
                    <ul class="sidebar-menu">
                        ...
                        <li class="treeview">
                            ...
                            <ul class="treeview-menu">
					            ...
					            <?php } ?>
                                <?php if(in_array('hylb_01',$WST_STAFF['grant']) and $USERS_MEMBERS == 0){ ?>
