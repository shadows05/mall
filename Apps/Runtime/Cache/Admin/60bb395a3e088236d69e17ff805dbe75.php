...
<html lang="zh-cn">
   <head>
      ...
      <link rel="stylesheet" href="/wstmall/Apps/Admin/View/css/AdminLTE.css">
      <!--[if lt IE 9]>
   ...
   <body>
      <div class='panel wst-panel-full'>
         <div class="col-xs-12 wstmall-login-tips">
             <p style='font-size:16px;'>您好，<?php echo session('WST_STAFF.staffName');?>，欢迎使用消费创富商城管理后台。 您上次登录的时间是 <?php echo session('WST_STAFF.lastTime');?> ，IP 是 <?php echo session('WST_STAFF.lastIP');?></p>
         </div>
